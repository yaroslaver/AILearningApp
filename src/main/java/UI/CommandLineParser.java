...
public class CommandLineParser {
  ...
  private boolean isDisabled, hasHighContrast, isUnsorted, hasNoise, hasSeveralStyles;
  ...
  public void parse(String[] args) {
    ...
    hasSeveralStyles = Boolean.valueOf(settings.get(4));
  ...
  private void help() {
    ...
    System.out.println(String.format("%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s", border, title, template, numOfCon,
            contrls, namesOfControls, quantityOfEach, highContrast, disabled, noise, unsorted, severalStyles, example, meaning));
  }
