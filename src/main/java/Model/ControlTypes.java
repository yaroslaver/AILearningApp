...
/**
 * This class(enum) contains different types of controls that can be generated by the application,
 * returns Swing Component corresponding to each control
...
public enum ControlTypes {
     ...
     * @param min -- min bound
     * @param max -- max bound
     * @return random integer in bounds
     */
